        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SLAs_TicketPriorities_TicketPriorityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketActivityLogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketActivityLogs", x => x.TicketActivityLogId);
                    table.ForeignKey(
